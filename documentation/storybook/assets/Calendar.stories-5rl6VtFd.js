...
render(<Example />)`,oe=`
  ...
  render(<Example />)`,Bt={title:"Components/Calendar",component:z,tags:["autodocs"],parameters:{layout:"centered"}},W={args:{value:new Date(2026,2,26),onChange:()=>{}},parameters:{layout:"padded",docs:{source:{code:re}}},render:()=>l.jsx("div",{style:{maxWidth:1080,margin:"0 auto"},children:l.jsx(fe,{code:re,noInline:!0,scope:{Calendar:z}})})},S={args:{value:new Date(2026,2,26),onChange:()=>{}},parameters:{layout:"padded",docs:{source:{code:oe}}},render:()=>l.jsx("div",{style:{maxWidth:1080,margin:"0 auto"},children:l.jsx(fe,{code:oe,noInline:!0,scope:{Calendar:z,addDays:X,addMonths:$,endOfMonth:ye,eachDayOfInterval:ge,getDay:q,isSameMonth:De,startOfMonth:we,subDays:Me,subMonths:xe}})})};var se,ie,ce;W.parameters={...W.parameters,docs:{...(se=W.parameters)==null?void 0:se.docs,source:{originalSource:`{
  args: {
  ...
  render: () => <div style={{
    ...
    margin: '0 auto'
      ...
      <LiveCodeBlock code={customCalendarCode} noInline scope={{
      Calendar,
      addDays,
      addMonths,
      endOfMonth,
