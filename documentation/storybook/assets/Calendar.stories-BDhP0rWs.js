...
`,Tt=D.div`
  color: ${t=>t.$color};
  opacity: ${t=>t.$opacity};
`,j=Object.assign(St,{Number:Yt,Value:Tt});function T({children:t,value:e,onClick:n,textStyle:a,...r}){const{currentMonth:o,value:s,onChange:i}=M.useContext(v),d=s&&s.getFullYear()===e.getFullYear()&&s.getMonth()===e.getMonth()&&s.getDate()===e.getDate(),u=De(e,o);return l.jsx(j,{children:l.jsx(j.Number,{$backgroundColor:u&&d?"#0d6efd":"transparent",onClick:()=>{u&&(i(e),n&&n(e))},...r,children:l.jsx(j.Value,{$color:d&&u?"#ffffff":"#000000",$opacity:u?1:.25,style:a,children:t||J(e,"d")})})})}try{T.displayName="CalendarDay",T.__docgenInfo={description:"",displayName:"CalendarDay",props:{value:{defaultValue:null,description:"",name:"value",required:!0,type:{name:"Date"}},onClick:{defaultValue:null,description:"",name:"onClick",required:!1,type:{name:"((value: Date) => void) | undefined"}},textStyle:{defaultValue:null,description:"",name:"textStyle",required:!1,type:{name:"CSSProperties | undefined"}}}}}catch{}const Nt=D.div`
  display: flex;
  flex-wrap: wrap;
`;function L({children:t,...e}){const{currentMonth:n}=M.useContext(v);function a(){const r=we(n),o=ye(r),s=ge({start:r,end:o}),i=q(r),d=q(o),u=new Array(i).fill(null).map((w,b)=>xe(r,i-b)),f=new Array(6-d).fill(null).map((w,b)=>X(o,b+1));return u.concat(s,f)}return l.jsx(Nt,{...e,children:t||a().map((r,o)=>l.jsx(T,{value:r},o))})}try{L.displayName="CalendarDays",L.__docgenInfo={description:"",displayName:"CalendarDays",props:{}}}catch{}const Ft=D.div`
  display: flex;
  align-items: center;
  justify-content: center;
  margin-bottom: 16px;
`;function R({children:t,...e}){return l.jsx(Ft,{...e,children:t})}try{R.displayName="CalendarHeader",R.__docgenInfo={description:"",displayName:"CalendarHeader",props:{}}}catch{}function B({children:t,onPress:e,...n}){const{currentMonth:a,setCurrentMonth:r}=M.useContext(v);return l.jsx("div",{onClick:()=>{const o=Me(a,1);r(o),e&&e(o)},...n,children:t||l.jsx("div",{children:"◀"})})}try{B.displayName="CalendarLeft",B.__docgenInfo={description:"",displayName:"CalendarLeft",props:{onPress:{defaultValue:null,description:"",name:"onPress",required:!1,type:{name:"((date: Date) => void) | undefined"}}}}}catch{}function V({children:t,onPress:e,...n}){const{currentMonth:a,setCurrentMonth:r}=M.useContext(v);return l.jsx("div",{onClick:()=>{const o=$(a,1);r(o),e&&e(o)},...n,children:t||l.jsx("div",{children:"▶"})})}try{V.displayName="CalendarRight",V.__docgenInfo={description:"",displayName:"CalendarRight",props:{onPress:{defaultValue:null,description:"",name:"onPress",required:!1,type:{name:"((date: Date) => void) | undefined"}}}}}catch{}const Et=D.div`
  font-size: 1.5rem;
  font-weight: bold;
  margin: 0 16px;
`;function A({children:t,...e}){const{currentMonth:n}=M.useContext(v);return l.jsx(Et,{...e,children:t||J(n,"MMMM yyyy")})}try{A.displayName="CalendarTitle",A.__docgenInfo={description:"",displayName:"CalendarTitle",props:{}}}catch{}const It=D.div`
  flex: 1;
  text-align: center;
  font-size: 1rem;
  color: #757575;
`;function N({children:t,...e}){return l.jsx(It,{...e,children:t})}try{N.displayName="CalendarWeekday",N.__docgenInfo={description:"",displayName:"CalendarWeekday",props:{}}}catch{}const jt=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],qt=D.div`
  display: flex;
`;function Q({children:t,...e}){return l.jsx(qt,{...e,children:t||jt.map(n=>l.jsx(N,{children:n},n))})}try{Q.displayName="CalendarWeekdays",Q.__docgenInfo={description:"",displayName:"CalendarWeekdays",props:{}}}catch{}const z=Object.assign(H,{Day:T,Days:L,Header:R,Left:B,Right:V,Title:A,Weekday:N,Weekdays:Q}),re=`function Example() {
...
}`,...(le=(ue=S.parameters)==null?void 0:ue.docs)==null?void 0:le.source}}};const At=["BasicCalendar","CustomCalendar"];export{W as BasicCalendar,S as CustomCalendar,At as __namedExportsOrder,Vt as default};
