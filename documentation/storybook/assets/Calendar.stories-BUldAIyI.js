...
`,Yt=D.div`
  color: ${t=>t.$color};
  opacity: ${t=>t.$opacity};
`,j=Object.assign(St,{Number:Wt,Value:Yt});function T({children:t,value:e,onClick:n,textStyle:a,...r}){const{currentMonth:o,value:s,onChange:i}=x.useContext(v),d=s&&s.getFullYear()===e.getFullYear()&&s.getMonth()===e.getMonth()&&s.getDate()===e.getDate(),u=De(e,o);return l.jsx(j,{children:l.jsx(j.Number,{$backgroundColor:u&&d?"#0d6efd":"transparent",onClick:()=>{u&&(i(e),n&&n(e))},...r,children:l.jsx(j.Value,{$color:d&&u?"#ffffff":"#000000",$opacity:u?1:.25,style:a,children:t||J(e,"d")})})})}try{T.displayName="CalendarDay",T.__docgenInfo={description:"",displayName:"CalendarDay",props:{value:{defaultValue:null,description:"",name:"value",required:!0,type:{name:"Date"}},onClick:{defaultValue:null,description:"",name:"onClick",required:!1,type:{name:"((value: Date) => void) | undefined"}},textStyle:{defaultValue:null,description:"",name:"textStyle",required:!1,type:{name:"CSSProperties | undefined"}}}}}catch{}const Tt=D.div`
  display: flex;
  flex-wrap: wrap;
`;function R({children:t,...e}){const{currentMonth:n}=x.useContext(v);function a(){const r=we(n),o=ye(r),s=ge({start:r,end:o}),i=q(r),d=q(o),u=new Array(i).fill(null).map((w,b)=>Me(r,i-b)),h=new Array(6-d).fill(null).map((w,b)=>X(o,b+1));return u.concat(s,h)}return l.jsx(Tt,{...e,children:t||a().map((r,o)=>l.jsx(T,{value:r},o))})}try{R.displayName="CalendarDays",R.__docgenInfo={description:"",displayName:"CalendarDays",props:{}}}catch{}const Nt=D.div`
  display: flex;
  align-items: center;
  justify-content: center;
  margin-bottom: 16px;
`;function L({children:t,...e}){return l.jsx(Nt,{...e,children:t})}try{L.displayName="CalendarHeader",L.__docgenInfo={description:"",displayName:"CalendarHeader",props:{}}}catch{}function B({children:t,onPress:e,...n}){const{currentMonth:a,setCurrentMonth:r}=x.useContext(v);return l.jsx("div",{onClick:()=>{const o=xe(a,1);r(o),e&&e(o)},...n,children:t||l.jsx("div",{children:"◀"})})}try{B.displayName="CalendarLeft",B.__docgenInfo={description:"",displayName:"CalendarLeft",props:{onPress:{defaultValue:null,description:"",name:"onPress",required:!1,type:{name:"((date: Date) => void) | undefined"}}}}}catch{}function V({children:t,onPress:e,...n}){const{currentMonth:a,setCurrentMonth:r}=x.useContext(v);return l.jsx("div",{onClick:()=>{const o=$(a,1);r(o),e&&e(o)},...n,children:t||l.jsx("div",{children:"▶"})})}try{V.displayName="CalendarRight",V.__docgenInfo={description:"",displayName:"CalendarRight",props:{onPress:{defaultValue:null,description:"",name:"onPress",required:!1,type:{name:"((date: Date) => void) | undefined"}}}}}catch{}const Ft=D.div`
  font-size: 1.5rem;
  font-weight: bold;
  margin: 0 16px;
`;function A({children:t,...e}){const{currentMonth:n}=x.useContext(v);return l.jsx(Ft,{...e,children:t||J(n,"MMMM yyyy")})}try{A.displayName="CalendarTitle",A.__docgenInfo={description:"",displayName:"CalendarTitle",props:{}}}catch{}const Et=D.div`
  flex: 1;
  text-align: center;
  font-size: 1rem;
  color: #757575;
`;function N({children:t,...e}){return l.jsx(Et,{...e,children:t})}try{N.displayName="CalendarWeekday",N.__docgenInfo={description:"",displayName:"CalendarWeekday",props:{}}}catch{}const It=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],jt=D.div`
  display: flex;
`;function Q({children:t,...e}){return l.jsx(jt,{...e,children:t||It.map(n=>l.jsx(N,{children:n},n))})}try{Q.displayName="CalendarWeekdays",Q.__docgenInfo={description:"",displayName:"CalendarWeekdays",props:{}}}catch{}const z=Object.assign(H,{Day:T,Days:R,Header:L,Left:B,Right:V,Title:A,Weekday:N,Weekdays:Q}),re=`function Example() {
...
render(<Example />)`,oe=`
  ...
  render(<Example />)`,Bt={title:"Components/Calendar",component:z,tags:["!autodocs"],parameters:{layout:"centered"}},S={args:{value:new Date(2026,2,26),onChange:()=>{}},parameters:{layout:"padded",docs:{source:{code:re}}},render:()=>l.jsx("div",{style:{maxWidth:1080,margin:"0 auto"},children:l.jsx(fe,{code:re,noInline:!0,scope:{Calendar:z}})})},W={args:{value:new Date(2026,2,26),onChange:()=>{}},parameters:{layout:"padded",docs:{source:{code:oe}}},render:()=>l.jsx(fe,{code:oe,noInline:!0,scope:{Calendar:z,addDays:X,addMonths:$,endOfMonth:ye,eachDayOfInterval:ge,getDay:q,isSameMonth:De,startOfMonth:we,subDays:Me,subMonths:xe}})};var se,ie,ce;S.parameters={...S.parameters,docs:{...(se=S.parameters)==null?void 0:se.docs,source:{originalSource:`{
  args: {
...
}`,...(ce=(ie=S.parameters)==null?void 0:ie.docs)==null?void 0:ce.source}}};var de,ue,le;W.parameters={...W.parameters,docs:{...(de=W.parameters)==null?void 0:de.docs,source:{originalSource:`{
  args: {
    value: new Date(2026, 2, 26),
    onChange: () => {}
  },
...
}`,...(le=(ue=W.parameters)==null?void 0:ue.docs)==null?void 0:le.source}}};const Vt=["BasicCalendar","CustomCalendar"];export{S as BasicCalendar,W as CustomCalendar,Vt as __namedExportsOrder,Bt as default};
