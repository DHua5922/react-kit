import{j as t}from"./jsx-runtime-DiklIkkE.js";import{r as l}from"./index-DRjF_FHU.js";import{L as w}from"./index-QgfrSyUJ.js";const v={show:!1,onShow:()=>{},onHide:()=>{}},h=l.createContext(v);try{Context.displayName="Context",Context.__docgenInfo={description:`Context lets components pass information deep down without explicitly
passing props.
...
}`,...(M=(y=s.parameters)==null?void 0:y.docs)==null?void 0:M.source}}};const D=["Example"],A=Object.freeze(Object.defineProperty({__proto__:null,Example:s,__namedExportsOrder:D,default:L},Symbol.toStringTag,{value:"Module"}));export{s as E,c as M,A as S};
