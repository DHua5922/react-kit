import{j as i}from"./jsx-runtime-DiklIkkE.js";import{r}from"./index-DRjF_FHU.js";import{P as v}from"./index-CgmY5G0d.js";import{L as P}from"./index-QgfrSyUJ.js";const V={showMenu:!1,onShowMenu:()=>{},onHideMenu:()=>{},onSelect:()=>{},offsetMenuPosVertical:0,offsetMenuPosHorizontal:0,menuPos:{top:"0px",left:"0px"},setMenuPos:()=>{}},f=r.createContext(V);try{Context.displayName="Context",Context.__docgenInfo={description:`Context lets components pass information deep down without explicitly
passing props.
...
}`,...(b=(C=d.parameters)==null?void 0:C.docs)==null?void 0:b.source}}};const $=["Example"],L=Object.freeze(Object.defineProperty({__proto__:null,Example:d,__namedExportsOrder:$,default:E},Symbol.toStringTag,{value:"Module"}));export{d as E,_ as M,L as S,g as a};
